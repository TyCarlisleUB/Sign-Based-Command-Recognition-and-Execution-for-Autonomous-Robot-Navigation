...
Autonomous vehicles operating in the real world must recognize and respond to traffic signage — not just obstacles or lanes. Most introductory robotics platforms focus on line-following or color-based navigation, but leave out the layer that matters most in practice: understanding what signs mean and acting on them.
